...
var ClosureSubjectExecutor = /** @class */ (function () {
    ...
    ClosureSubjectExecutor.prototype.update = function (subject) {
        return __awaiter(this, void 0, void 0, function () {
            var parent, entity, childrens, oldParent, oldParentId, parentId, escape, previousParent, hasPreviousParent, closureTable_1, ancestorColumnNames_1, descendantColumnNames_1, createSubQuery_1, parameters, _a, _b, column, queryParams_1, tableName, superAlias_1, subAlias_1, select, entityWhereCondition, parentWhereCondition;
            var e_1, _c;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!entity && parent) {
                            childrens = subject.metadata.treeChildrenRelation.getEntityValue(parent);
                            if (!!childrens)
                        ...
                        createSubQuery_1 = function (qb, alias) {
                            ...
                            try {
                                ...
                                for (var _b = __values(closureTable_1.ancestorColumns), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    var column = _c.value;
                    ...
                    case 1:
                        ...
                        select = __spread(ancestorColumnNames_1.map(function (columnName) { return superAlias_1 + "." + columnName; }), descendantColumnNames_1.map(function (columnName) { return subAlias_1 + "." + columnName; }));
                        entityWhereCondition = subject.metadata.closureJunctionTable.ancestorColumns.map(function (column) {
                            ...
                            var parameterName = _this.queryRunner.connection.driver.createParameter("entity_" + column.referencedColumn.databaseName, queryParams_1.length - 1);
                        ...
                        parentWhereCondition = subject.metadata.closureJunctionTable.descendantColumns.map(function (column) {
                            ...
                            var parameterName = _this.queryRunner.connection.driver.createParameter("parent_entity_" +
                                column.referencedColumn.databaseName, queryParams_1.length - 1);
                            return superAlias_1 + "." + columnName + " = " + parameterName;
                        });
                        return [4 /*yield*/, this.queryRunner.query("INSERT INTO " + tableName + " (" + __spread(ancestorColumnNames_1, descendantColumnNames_1).join(", ") + ") " +
                                ("SELECT " + select.join(", ") + " ") +
                                ("FROM " + tableName + " AS " + superAlias_1 + ", " + tableName + " AS " + subAlias_1 + " ") +
                                ("WHERE " + __spread(entityWhereCondition, parentWhereCondition).join(" AND ")), queryParams_1)];
                    case 2:
                        _d.sent();
                        _d.label = 3;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        whereCondition = subject.metadata.closureJunctionTable.descendantColumns.map(function (column) {
                            ...
                            var parameterName = _this.queryRunner.connection.driver.createParameter("parent_entity_" + column.referencedColumn.databaseName, queryParams.length - 1);
