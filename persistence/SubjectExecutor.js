                ...
                switch (_d.label) {
                    case 0:
                        updateSubject = function (subject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var partialEntity, manager, updateMap, _a, updateQueryBuilder, updateResult;
                            var _this = this;
                            return tslib_1.__generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(tslib_1.__spread(remainingSubjects.map(updateSubject), [nestedSetPromise]))];
                    case 1:
                        // Run all remaning subjects in parallel
                        _d.sent();
                        return [2 /*return*/];
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, new NestedSetSubjectExecutor_1.NestedSetSubjectExecutor(this.queryRunner).remove(subjects)];
                    case 5:
                        _c.sent();
                        _c.label = 6;
                    case 6: 
