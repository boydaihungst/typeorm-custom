...
var ClosureSubjectExecutor = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            ...
                            this.queryRunner.manager
                                ...
                                .insert()
                                .into(
                                    subject.metadata.closureJunctionTable
                                        .tablePath
                                )
                    ...
                    case 1:
                        // insert values into the closure junction table
                        _a.sent();
                        parent = subject.metadata.treeParentRelation.getEntityValue(
                            subject.entity
                        );
                        if (
                            !parent &&
    ...
    ClosureSubjectExecutor.prototype.update = function (subject) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var parent,
                ...
                hasPreviousParent,
                closureTable_1,
                ancestorColumnNames_1,
                descendantColumnNames_1,
                createSubQuery_1,
                parameters,
                _a,
                _b,
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!entity) {
                            childrens = subject.metadata.treeChildrenRelation.getEntityValue(
                                parent
                            );
                            if (!!childrens)
                                entity = childrens.find(function (child) {
                        ...
                        oldParent = subject.metadata.treeParentRelation.getEntityValue(
                            entity
                        );
                        oldParentId = subject.metadata.getEntityIdMap(
                            oldParent
                        );
                        parentId = subject.metadata.getEntityIdMap(parent);
                        // Exit if the new and old parents are the same
                        if (
                            OrmUtils_1.OrmUtils.compareIds(
                                oldParentId,
                                parentId
                            )
                        ) {
                        ...
                        escape = function (alias) {
                            return _this.queryRunner.connection.driver.escape(
                                alias
                            );
                        };
                        previousParent = subject.metadata.treeParentRelation.getEntityValue(
                            entity
                        );
                        hasPreviousParent = subject.metadata.primaryColumns.some(
                            function (column) {
                                return (
                                    column.getEntityValue(previousParent) !=
                                    null
                                );
                            }
                        );
                        ...
                        ancestorColumnNames_1 = closureTable_1.ancestorColumns.map(
                            function (column) {
                                return escape(column.databaseName);
                            }
                        );
                        descendantColumnNames_1 = closureTable_1.descendantColumns.map(
                            function (column) {
                                return escape(column.databaseName);
                            }
                        );
                            ...
                            try {
                                ...
                                for (
                                    var _b = tslib_1.__values(
                                            closureTable_1.ancestorColumns
                                        ),
                                        _c = _b.next();
                                    !_c.done;
                                    _c = _b.next()
                        ...
                        return [
                            ...
                            this.queryRunner.manager
                                ...
                                .where(function (qb) {
                                    return (
                                        "(" +
                                        descendantColumnNames_1.join(", ") +
                                        ") IN (" +
                                        createSubQuery_1(qb, "descendant") +
                                        ")"
                                    );
                                })
                                .andWhere(function (qb) {
                                    return (
                                        "(" +
                                        ancestorColumnNames_1.join(", ") +
                                        ") NOT IN (" +
                                        createSubQuery_1(qb, "ancestor") +
                                        ")"
                                    );
                                })
                    ...
                    case 1:
                        ...
                        select = tslib_1.__spread(
                            ancestorColumnNames_1.map(function (columnName) {
                                return superAlias_1 + "." + columnName;
                            }),
                            descendantColumnNames_1.map(function (columnName) {
                                return subAlias_1 + "." + columnName;
                            })
                        );
                        entityWhereCondition = subject.metadata.closureJunctionTable.ancestorColumns.map(
                            function (column) {
                                var columnName = escape(column.databaseName);
                                var entityId = column.referencedColumn.getEntityValue(
                                    entity
                                );
                                queryParams_1.push(entityId);
                                var parameterName = _this.queryRunner.connection.driver.createParameter(
                                    "entity_" +
                                        column.referencedColumn.databaseName,
                                    queryParams_1.length - 1
                                );
                                return (
                                    subAlias_1 +
                                    "." +
                        ...
                        parentWhereCondition = subject.metadata.closureJunctionTable.descendantColumns.map(
                            function (column) {
                                var columnName = escape(column.databaseName);
                                var parentId = column.referencedColumn.getEntityValue(
                                    parent
                                );
                                if (!parentId)
                                    throw new CannotAttachTreeChildrenEntityError_1.CannotAttachTreeChildrenEntityError(
                    ...
                    case 4:
                        return [
                            4 /*yield*/,
                            this.insertClosureEntry(subject, entity, parent),
                        ];
                    case 5:
                        _d.sent();
                        _d.label = 6;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        closureTable =
                            subjects[0].metadata.closureJunctionTable;
                        generateWheres = function (columns) {
                            return columns
                                .map(function (column) {
                                    var data = identifiers.map(function (
                                        identifier
                                    ) {
                                        return identifier[
                                            column.referencedColumn.databaseName
                        ...
                        ancestorWhere = generateWheres(
                            closureTable.ancestorColumns
                        );
                        descendantWhere = generateWheres(
     ...
     */
    ClosureSubjectExecutor.prototype.insertClosureEntry = function (
        subject,
        entity,
        parent
    ) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        queryParams = [];
                        ancestorColumnNames = subject.metadata.closureJunctionTable.ancestorColumns.map(
                            function (column) {
                                return escape(column.databaseName);
                            }
                        );
                        descendantColumnNames = subject.metadata.closureJunctionTable.descendantColumns.map(
                            function (column) {
                                return escape(column.databaseName);
                            }
                        );
                        childEntityIds1 = subject.metadata.primaryColumns.map(
                            function (column) {
                                queryParams.push(
                                ...
                                return _this.queryRunner.connection.driver.createParameter(
                                    "child_entity_" + column.databaseName,
                                    queryParams.length - 1
                                );
                            }
                        );
                        whereCondition = subject.metadata.closureJunctionTable.descendantColumns.map(
                            function (column) {
                                var columnName = escape(column.databaseName);
                                var parentId = column.referencedColumn.getEntityValue(
                                    parent
