...
var ClosureSubjectExecutor = /** @class */ (function () {
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (parent) {
                            ...
                            this.queryRunner.query("INSERT INTO " + tableName + " (" + tslib_1.__spread(ancestorColumnNames_1, descendantColumnNames_1).join(", ") + ") " +
                                ("SELECT " + select.join(", ") + " ") +
    ...
    ClosureSubjectExecutor.prototype.insertClosureEntry = function (subject, entity, parent) {
        ...
        this.queryRunner.query("INSERT INTO " + tableName + " (" + tslib_1.__spread(ancestorColumnNames, descendantColumnNames).join(", ") + ") " +
